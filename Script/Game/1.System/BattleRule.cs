...
//    //플레이어 정보
//    public List<Entity> player = new();

//    //적 정보
//    public List<Entity> enemy =new();

//    //팀 정보
//    private (List<Entity> self, List<Entity> target) Entity = new();
...
//        var qPlayer = query.ToEntityArray(Allocator.Temp);
//        player[0] = manager.CreateEntity();
//        player[0] = qPlayer[0];
//        qPlayer.Dispose();
...
//        Debug.Log($"현재 턴 : {turn}");
//        Debug.Log($"[플레이어 턴 시작] AP: {manager.GetComponentData<UnitData>(player[0]).signal}");
//    }
...
//        //두 팀 중 하나가 전멸시 전투 종료 
//        if (!manager.GetComponentData<UnitData>(Entity.self[0]).isAlive || !manager.GetComponentData<UnitData>(Entity.target[0]).isAlive)
//        {
//            EndTurn();
//        }
//    }
...
//    //공수 교대 튜플 함수
//    private (List<Entity> self, List<Entity> target) SetTurnEntites()
//    {
