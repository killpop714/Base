...
namespace Game.Battle
{
    ...
    public class CombatantSO : ScriptableObject, IComponentData
    {
        ...
        {
            new() { DisplayName="Head", MaxHP=30, HP=30, type=PartType.Vital,Enabled=true},
            new() { DisplayName="Trunk", MaxHP=30, HP=30, type=PartType.Core,Enabled=true},
            new() { DisplayName="Arm", MaxHP=30, HP=30, type=PartType.Hand,Enabled=true},
            new() { DisplayName="Leg", MaxHP=30, HP=30, type=PartType.Leg,Enabled=true}
        };
